...
public interface ImageResourceRepository extends BaseRepository<ImageResource,Long>{
	...
	@Query(value="select a.commodity.imageResource from CommodityBoxPortCateRel a,in(a.boxPortCate.boxPorts) b where b.box.boxCode=?1 group by a.commodity.imageResource")
