...
import framework.core.interceptor.RouteInterceptor;
...
//      registry.addInterceptor(new RouteInterceptor()).addPathPatterns("/route/**");
    }
    ...
    public void addResourceHandlers(ResourceHandlerRegistry registry) {
        ...
        registry.addResourceHandler("/front/admin/**").addResourceLocations("classpath:/static/admin/");
