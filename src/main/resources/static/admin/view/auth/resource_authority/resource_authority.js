...
(function () {
    DD.createModule({
        name: "m_resource_authority",
        delayInit: true,
        templateUrl: BASEHTML + '/auth/resource_authority/resource_authority.html',
        data: {
            left_page: 1,
            left_searchName: '',
            left_total:0,
        ...
        methods: {
            ...
            updateLeftPage: function (params) {
	            ...
	            DD.request({
					...
					successFunc:function(r){
						...
						me.data.resourceId = r.result.content[0].resourceId;
            ...
            updateBinds: function (params) {
                var me = this;
	            DD.request({
					url:DATAURL + '/back/auth/resource/getAuth',
					params: params,
					reqType:'POST',
					type:'json',
					async:true,
            ...
            */
            addBind: function (e, d, v) {
                ...
                DD.request({
					url:DATAURL + '/back/auth/resource/updAuth',
					params: {
						resourceId:me.data.resourceId,
