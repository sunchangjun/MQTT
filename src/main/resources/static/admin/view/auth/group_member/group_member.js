...
(function () {
    DD.createModule({
        name: "m_group_member",
        delayInit: true,
        templateUrl: BASEHTML + '/auth/group_member/group_member.html',
        data: {
            left_page: 1,
            left_searchName: '',
            left_total:0,
        ...
        onBeforeFirstRender: function () {
            var me = this;
			var params = {							/*左侧角色*/
				userName:me.data.left_searchName,
        ...
        methods: {
            ...
            updateLeftPage: function (params) {
	            ...
	            DD.request({
					...
					successFunc:function(r){
						...
						me.data.userId = r.result.content[0].userId;
            ...
            updateBinds: function (params) {
	            ...
	            DD.request({
					...
					successFunc:function(r){
						...
						var param = {							/*右侧权限*/
							groupName:me.data.right_searchName,
            ...
            updateRightPage: function (param) {
	            ...
	            DD.request({
					...
					/*请求成功回调*/
					successFunc:function(r){
						me.data.group_list = r.result.content;
						me.data.right_total = r.result.total;
						me.data.right_all_page = r.result.pageCount;
						me.data.group_list.forEach(function (item) {			/*对比列表项是否绑定*/
