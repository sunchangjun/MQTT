...
(function () {
    DD.createModule({
        name: "m_group",
        delayInit: true,
        templateUrl: BASEHTML + '/auth/group/group.html',
        data: {
            page: 1,
            rows: 10,
            searchName: '',
        ...
        methods: {
			...
			deleteItem: function (e, d, view) {
                var me = this;
                me.data.groupId = d.groupId;
                me.data.pop = true;
            },
           	del_auth:function(e,data,view){					
				var me =this;
				DD.request({
					url:DATAURL + '/back/auth/group/del',
					params: {groupId:me.data.groupId},
					reqType:'POST',
					type:'json',
					/*设置1秒超时*/
					timeout:5000,
            ...
            confirmAdd: function (e, d, v) {
                ...
                DD.request({
					url:DATAURL + '/back/auth/group/add',
					params: {
						remarks:me.data.add_remarks,
						groupName:me.data.add_name
					},
					reqType:'POST',
					type:'json',
					async:true,
